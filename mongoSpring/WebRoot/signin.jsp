		...
		<form id="myForm" class="main" onsubmit="return check()" action="${ctx }/user/login.action" method="post">
	        <div class="span4 box">
	            <div class="content-wrap">
	                <h6>Log in</h6>
	                <input class="span12 input-xlarge" type="text" placeholder="E-mail address" required 
	                pattern="^\w+((-\w+)|(\.\w+))*\@[A-Za-z0-9]+((\.|-)[A-Za-z0-9]+)*\.[A-Za-z0-9]+$"/>
	                <input class="span12 input-xlarge" type="password" placeholder="Your password" required/>
